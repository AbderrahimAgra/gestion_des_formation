            ...
            <main>
                <div className="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                    <div className="sm:px-0">
                        <div>
                            <button onClick={()=>{setSelectedFormation({})}} className="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-primary-800">Add Formation</button>
                                                ...
                                                formations.map((formation, key) => {
                                                    return (<tr key={key}>
                                                        ...
                                                        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm text-right">
                                                            <button onClick={() => { updateFormation(formation._id) }} type="button" className="inline-block text-gray-500 hover:text-gray-700 mx-3">
                                                            ...
                                                            <button onClick={() => { deleteFormation(formation._id) }} type="button" className="inline-block text-gray-500 hover:text-gray-700 mx-3">

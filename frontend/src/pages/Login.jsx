        ...
        <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            <form onSubmit={login} className="space-y-4 md:space-y-6" action="#">
              {!error || <p className='text-red-700 text-center'> The credentiels are wrong, check and try again </p>}
              <div>
                <label
                  htmlFor="email"
              ...
              >
              {isLoading ? (<div className='w-100 flex justify-center'><svg aria-hidden="true" className="w-4 h-4 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
